...
`4307936-ps17-cmp02`. The version is derived from `remote-compose-upstream.json`; bump its
...
dependencies {
  implementation("ee.schimke.remotecompose:remote-material3:4307936-ps17-cmp02")
}
```
