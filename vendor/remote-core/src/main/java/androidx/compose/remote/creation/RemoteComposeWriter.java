...
public class RemoteComposeWriter {
    ...
    public RemoteComposeWriter(@NonNull Profile profile, HTag @NonNull ... tags) {
        ...
        mBuffer.setWriterVersion(profile.getApiLevel(), profile.getOperationsProfiles());
    ...
    public RemoteComposeWriter(@NonNull RcPlatformServices platform, int apiLevel,
        ...
        mBuffer.setWriterVersion(apiLevel, profiles);
    ...
    public RemoteComposeWriter(
        ...
        mBuffer.setWriterVersion(mApiLevel, HTag.getProfiles(tags));
        mBuffer.addHeader(HTag.getTags(tags), HTag.getValues(tags));
    }
    ...
    /** Returns the component currently being written without exposing the wire buffer. */
    public int getLastComponentId() {
        return mBuffer.getLastComponentId();
    }
    ...
    public int addNamedString(@NonNull String name, @NonNull String initialValue) {
        int id = mState.createNextAvailableId();
        mBuffer.setNamedVariable(id, name, NamedVariable.STRING_TYPE);
        WriteOperations.textData(mBuffer.getBuffer(), id, initialValue);
        return id;
    }
    ...
    public long addNamedInt(@NonNull String name, int initialValue) {
        ...
        WriteOperations.integerConstant(mBuffer.getBuffer(), id, initialValue);
    ...
    public float addNamedFloat(@NonNull String name, float initialValue) {
        ...
        WriteOperations.floatConstant(mBuffer.getBuffer(), id, initialValue);
    ...
    public int addNamedLong(@NonNull String name, long initialValue) {
        ...
        WriteOperations.longConstant(mBuffer.getBuffer(), id, initialValue);
        return id;
    }
    ...
    public void addIncludeReferencedOperations(int id) {
        WriteOperations.includeReferencedOperations(mBuffer.getBuffer(), id);
    }
    ...
    public void patternInflation(int id, int @NonNull [] argIds) {
        WriteOperations.patternInflation(mBuffer.getBuffer(), id, argIds);
    }
    ...
    public void addPatternBlock(int paramIndex) {
        WriteOperations.patternBlock(mBuffer.getBuffer(), paramIndex);
    }
    ...
    public void addPatternArgument(int paramIndex) {
        WriteOperations.patternArgument(mBuffer.getBuffer(), paramIndex);
    }
    ...
    public void addPatternForEach(int collectionId, int localItemId) {
        WriteOperations.patternForEach(mBuffer.getBuffer(), collectionId, localItemId);
    }
    ...
    public void addModifierScroll(int direction, float positionId) {
        ...
        WriteOperations.scrollModifier(mBuffer.getBuffer(), direction, positionId, max, notchMax);
        mBuffer.addTouchExpression(
